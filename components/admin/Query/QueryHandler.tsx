...
function QueryHandler({ data }: { data: Query }) {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-20 lg:px-8 py-12 relative z-10">
              ...
              Query
                    ...
                    <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed font-light">
                        Detailed view of customer inquiry and support request
                    </p>
                </div>
                    ...
                    <CardHeader className="pb-6">
                        <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-2xl font-bold text-white mb-2">{data.name}</CardTitle>
                                    <p className="text-gray-400 text-sm">Query ID: {data.id}</p>
                                </div>
                            </div>
                            <Badge
                                variant="outline"
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div className="flex flex-wrap gap-4 pt-6 border-t border-purple-500/20">
                            <Button
                                ...
                                disabled={data.isSolved}
                            >
                                <CheckCircle className="w-4 h-4 mr-2" />
                                {data.isSolved ? "Already Solved" : "Mark as Solved"}
                            </Button>
